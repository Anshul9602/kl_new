...
<main id="main">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 hero-content">
          <h1 class="hero-title">khatri 666 Official App | Live Results, Charts & Predictions</h1>
          <p class="hero-subtitle">Welcome to the Official khatri 666. Get real-time results, charts, predictions & app downloads.</p>
          <div class="d-flex flex-wrap gap-3">
            <a href="assets/maalaxmi.apk" class="download-btn">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"></path>
                <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"></path>
              </svg>
              Download khatri 666 App
            </a>
        ...
        <div class="col-lg-6 text-center">
          <img src="assets/images/banner.png" alt="khatri 666 App" class="img-fluid" style="max-height: 500px;">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="why-play-section">
    <div class="container">
      <h2 class="section-title">Why play game on khatri 666?</h2>
      <div class="row">
      ...
      <div class="row pt-3 pb-3">
        <div class="top_headpart d-flex justify-content-between align-items-center">
          ...
          <div class="top_btns d-flex ">
            <a href="assets/maalaxmi.apk" class="btn btn_black d-flex align-items-center me-2">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-8 text-center">
          <div class="content-market">
            <h2 data-aos="fade-right" data-aos-duration="1000" class="aos-init">khatri 666 Admin Notice</h2>
            <h3 data-aos="fade-left" data-aos-delay="50" data-aos-duration="1200" class="aos-init">
              <p>WELCOME TO khatri 666 GAME </p>
    ...
    <div class="row">
      <div class="col-xl-12">
        <div class="footer-copy text-center">
          <p class="py-3"><a href="">@2026 khatri 666</a></p>
        </div>
      </div>
    </div>
  </div>
