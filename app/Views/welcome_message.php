    ...
    <header id="header" class="header d-flex align-items-center addclass nav-down">
        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            <a href="#" class="logo d-flex align-items-center">
               <img src="image/logo1.png" style="max-width:250px;" alt="">
            </a>
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a href="#rate">Rate Chart</a></li>
                </ul>
            </nav><!-- .navbar -->
...
<link href="assets/css/matkafun-style.css" rel="stylesheet">
...
<main id="main">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 hero-content">
          <h1 class="hero-title">khatri 567 Official App | Live Results, Charts & Predictions</h1>
          <p class="hero-subtitle">Welcome to the Official khatri 567. Get real-time results, charts, predictions & app downloads.</p>
          <div class="d-flex flex-wrap gap-3">
            <a href="app-release.apk" class="download-btn">
              ...
              Download khatri 567 App
            </a>
            <a href="https://wa.me/918302028882" class="whatsapp-btn" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                <path d="M13.601 2.326A7.854 7.854 0 0 0 7.194 0C3.256 0 0 3.256 0 7.194c0 1.982.906 3.76 2.326 4.973L0 16l3.833-2.326A7.933 7.933 0 0 0 7.194 14.4c3.938 0 7.194-3.256 7.194-7.194 0-1.982-.906-3.76-2.326-4.973zM7.194 12.8a5.61 5.61 0 0 1-2.876-.788l-.207-.12-2.188.636.636-2.133-.12-.207a5.6 5.6 0 0 1-.788-2.876c0-3.085 2.51-5.595 5.595-5.595a5.61 5.61 0 0 1 2.876.788l.207.12 2.188-.636-.636 2.133.12.207c.515.89.788 1.9.788 2.876 0 3.085-2.51 5.595-5.595 5.595z"/>
              </svg>
              WhatsApp Call Now
            </a>
          </div>
        ...
        <div class="col-lg-6 text-center">
          <img src="assets/images/banner.png" alt="khatri 567 App" class="img-fluid" style="max-height: 500px;">
        </div>
      </div>
    </div>
  </section>

  <!-- Why Play Game Section -->
  <section class="why-play-section">
    <div class="container">
      <h2 class="section-title">Why play game on khatri 567?</h2>
      <div class="row">
        <div class="col-lg-3 col-md-6 mb-4">
          <div class="feature-card">
            <div class="feature-icon">⚡</div>
            <h3 class="feature-title">Instant Deposit And Withdraw</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-4">
          <div class="feature-card">
            <div class="feature-icon">⭐</div>
            <h3 class="feature-title">4.5 Star Ratings</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-4">
          <div class="feature-card">
            <div class="feature-icon">🛡️</div>
            <h3 class="feature-title">Trusted ICON</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-4">
          <div class="feature-card">
  ...
  <!-- Game Rates Section -->
  <?php if(isset($rates) && $rates): ?>
  <section class="rates-section">
    <div class="container">
      <h2 class="section-title">Rate for you - Game Rates</h2>
      <div class="row">
        <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
          <div class="rate-card">
            <div class="rate-label">Single Ank</div>
            <div class="rate-value"><?php echo isset($rates->Single_Digit_Amount) ? $rates->Single_Digit_Amount : '9.75'; ?>/</div>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
          <div class="rate-card">
            <div class="rate-label">Jodi</div>
            <div class="rate-value"><?php echo isset($rates->Jodi_Digit_Amount) ? $rates->Jodi_Digit_Amount : '97.5'; ?>/</div>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
          <div class="rate-card">
            <div class="rate-label">Red Jodi</div>
            <div class="rate-value"><?php echo isset($rates->Jodi_Digit_Amount) ? $rates->Jodi_Digit_Amount : '97.5'; ?>/</div>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
          <div class="rate-card">
            <div class="rate-label">Single Panna</div>
            <div class="rate-value"><?php echo isset($rates->Single_Panna_Amount) ? $rates->Single_Panna_Amount : '160'; ?>/</div>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
          <div class="rate-card">
            <div class="rate-label">Double Panna</div>
            <div class="rate-value"><?php echo isset($rates->Double_Panna_Amount) ? $rates->Double_Panna_Amount : '320'; ?>/</div>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
          <div class="rate-card">
            <div class="rate-label">Triple Panna</div>
            <div class="rate-value"><?php echo isset($rates->Tripple_Panna_Amount) ? $rates->Tripple_Panna_Amount : '1000'; ?>/</div>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
          <div class="rate-card">
            <div class="rate-label">Half Sangam</div>
            <div class="rate-value"><?php echo isset($rates->Half_Sangam_Amount) ? $rates->Half_Sangam_Amount : '1000'; ?>/</div>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
          <div class="rate-card">
            <div class="rate-label">Full Sangam</div>
            <div class="rate-value"><?php echo isset($rates->Full_Sangam_Amount) ? $rates->Full_Sangam_Amount : '10000'; ?>/</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- ======= Scroll Sections ======= -->
  <section class="live_results section_padding_1">
    <div class="container">
      <div class="row pt-3 pb-3">
        <div class="top_headpart d-flex justify-content-between align-items-center">
          <div class="heading_sec">
            <h2 class="title-red">Live Result</h2>
            <p>Sabse Tezz Live Result Yahi Milega</p>
          </div>
          <div class="top_btns d-flex ">
            <a href="app-release.apk" class="btn btn_black d-flex align-items-center me-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="me-1" fill="#ffffff" viewBox="0 0 16 16">
                <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z"></path>
              </svg>
              Matka Play</a>
            <a href="<?php echo base_url(); ?>" class="btn btn_red d-flex align-items-center"> <svg xmlns="http://www.w3.org/2000/svg" class="me-1" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="16" height="16" x="0" y="0" viewBox="0 0 128 128" style="enable-background:new 0 0 512 512" xml:space="preserve">
                <g>
                  <path d="M16 64a4 4 0 0 1-8 0C8 33.121 33.121 8 64 8c15.391 0 29.632 6.133 40 16.693V12a4 4 0 0 1 8 0v24a4 4 0 0 1-4 4H84a4 4 0 0 1 0-8h15.908C90.933 21.904 78.022 16 64 16c-26.467 0-48 21.533-48 48zm100-4a4 4 0 0 0-4 4c0 26.467-21.533 48-48 48-14.022 0-26.933-5.904-35.908-16H44a4 4 0 0 0 0-8H20a4 4 0 0 0-4 4v24a4 4 0 0 0 8 0v-12.693C34.368 113.867 48.609 120 64 120c30.879 0 56-25.121 56-56a4 4 0 0 0-4-4z" fill="#ffffff" data-original="#000000" class=""></path>
                </g>
              </svg> Referesh</a>
          </div>
        </div>
      </div>
      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 row-cols-xxl-3 my-4 justify-content-center">




        <div class="col mb-3 aos-init" data-aos="fade-right" data-aos-delay="50" data-aos-duration="1000">
          <div class="result_card h-100">
            <div class="topSide">
              <h4 class="pb-3">SUPER MORNING</h4>
            </div>
            <div class="container ">
              <div class="row justify-content-center">
                <div class="col-xl-10 col-md-10">
                  <div class="center-tags">
                    <div class="row justify-content-center">
                      <div class="col-lg-4 col-4 col-md-3 text-center">
                        <h4>Loading... </h4>
                      </div>
                    </div>
                  </div>
            ...
            <div class="bottomSide text-center">
              <div class="row justify-content-center">
                <div class="col-xl-9 col-md-9">
                  <div class="time-clock d-flex justify-content-between align-items-center">
                    <a href="" class="d-flex align-items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
              ...
              <p class="pt-3 text-center fs-16"></p>
              <p>फ्री अंक से ओपन 1 पास</p>
              <p></p>
            </div>
          </div>
        </div>
        <div class="col mb-3 aos-init" data-aos="fade-right" data-aos-delay="50" data-aos-duration="1000">
          <div class="result_card h-100">
            <div class="topSide">
              <h4 class="pb-3">KARNATAKA DAY</h4>
            </div>
            <div class="container ">
              <div class="row justify-content-center">
                <div class="col-xl-10 col-md-10">
            ...
            <div class="bottomSide text-center">
              ...
              <p class="pt-3 text-center fs-16"></p>
              <p>फ्री अंक से ओपन 7 पास&nbsp;</p>
              <p>फ्री अंक से ओपन पाना 458 पास</p>
              <p></p>
            </div>
          </div>
        </div>
      ...
      <div data-aos="fade-up" class="aos-init">
        <div class="text-center">
          <b>
            <p>KALYAN MATKA | MATKA RESULT | KALYAN MATKA TIPS | SATTA MATKA | MATKA.COM | MATKA PANA JODI TODAY | BATTA SATKA | MATKA PATTI JODI NUMBER | MATKA RESULTS | MATKA CHART | MATKA JODI | SATTA COM | FULL RATE GAME | MATKA GAME | MATKA WAPKA | ALL MATKA RESULT LIVE ONLINE | MATKA RESULT | KALYAN MATKA RESULT | DPBOSS MATKA 143 | MAIN MATKA | SATTA MATKA 143 | MADHUR BAZAR | GALI DESAWAR | SATTA KING | GALI RESULT</p>
          </b>
        </div>
      </div>
    </div>
  ...
  <section class="section_padding_1 marketing_bg">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-8 text-center">
          <div class="content-market">
            <h2 data-aos="fade-right" data-aos-duration="1000" class="aos-init">khatri 567 Admin Notice</h2>
            <h3 data-aos="fade-left" data-aos-delay="50" data-aos-duration="1200" class="aos-init">
              <p>WELCOME TO khatri 567 GAME </p>
              <p>सबसे तेज खबर यही मिलेगी&nbsp;</p>
              <p>Online Matka Play App</p>
            </h3>
          </div>
  ...
  <section class="best_online">
    <div class="container">
      <div class="row justify-content-center ">
        <div class="col-xl-9 py-4">
          <a href="app-release.apk">
            <img src="https://deepmatka.co.in/uploads/images/gif_matka_1676045365.gif" alt="" width="100%">
          </a>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="title-onilne text-center">
            <h2 class="section-title aos-init" data-aos="zoom-in" data-aos-duration="1000">Available Games And Timetable</h2>
            <p data-aos="zoom-out" data-aos-duration="1400" class="aos-init">We have multiple types of games for you</p>
          </div>
        </div>
      </div>
      ...
      <?php   
        foreach ($post as $game){
          // Determine if game is open or closed based on current time
          $current_time = date('H:i');
          $open_time = date('H:i', strtotime($game['open_t']));
          $close_time = date('H:i', strtotime($game['close_t']));
          $is_open = ($current_time >= $open_time && $current_time <= $close_time);
      ?>
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="game-card">
            <div class="game-header">
              <h3 class="game-title"><?php echo htmlspecialchars($game['g_title']); ?></h3>
              <span class="game-status <?php echo $is_open ? 'status-open' : 'status-closed'; ?>">
                <?php echo $is_open ? 'Open for today' : 'Closed for today'; ?>
              </span>
            </div>
            <div class="game-result">
              <?php echo htmlspecialchars($game['open_num']); ?>-<?php echo htmlspecialchars($game['start']); ?><?php echo htmlspecialchars($game['end']); ?>-<?php echo htmlspecialchars($game['close_num']); ?>
            </div>
            <div class="game-time">
              <span>📅 Date: <?php echo htmlspecialchars($game['date']); ?></span>
              <span>⏰ <?php echo htmlspecialchars($game['open_t']); ?> - <?php echo htmlspecialchars($game['close_t']); ?></span>
            </div>
            <div class="text-center">
              <a href="/chart/<?php echo htmlspecialchars($game['g_id']); ?>" class="chart-link">Jodi Chart | Panna Chart</a>
            </div>
          </div>
        </div>
      <?php } ?>
  ...
  <section class="enquiry_part">
    <div class="container">
      <div class="row ">
        <div class="col-xl-8 col-lg-8  mb-3">
          <div class="enquiry_box">
            <div class="row justify-content-center align-items-center">
              <div class="col-xl-7 col-lg-7 col-md-7 mobiel-order_1">
                <div class="content-enquiry">
                  <h3 data-aos="zoom-in" data-aos-duration="1000" class="aos-init aos-animate">Email for any inquiries Or
                    Support:</h3>
                  <a href="mailto: kalyanlaxmi143@gmail.com " class="btn btn_red my-3 aos-init aos-animate" data-aos="fade-right">
                    Kalyanlaxmi143@gmail.com
                  </a>
                </div>
              </div>
              <div class="col-xl-3 col-lg-3 col-md-5 text-center mobiel-order_2">
                <div class="svges aos-init aos-animate" data-aos="flip-right" data-aos-duration="1000">
                  <svg width="156" height="166" viewBox="0 0 156 166" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M142.247 81.0954L71.5718 126.328L0.898438 81.0954L71.5718 20.2344L142.247 81.0954Z" fill="#6D3E18"></path>
                    <path d="M127.617 39.1875H15.2031V133.309H127.617V39.1875Z" fill="white"></path>
                    <path d="M98.346 62.4691H42.7217C40.2523 62.4691 38.2313 60.4481 38.2313 57.9787C38.2313 55.5092 40.2523 53.4883 42.7217 53.4883H98.346C100.815 53.4883 102.836 55.5092 102.836 57.9787C102.836 60.4481 100.815 62.4691 98.346 62.4691ZM111.512 74.9418H29.5572C28.3219 74.9418 27.3125 73.9313 27.3125 72.6972C27.3125 71.463 28.323 70.4525 29.5572 70.4525H111.512C112.746 70.4525 113.756 71.463 113.756 72.6972C113.756 73.9313 112.746 74.9418 111.512 74.9418ZM111.512 83.3388H29.5572C28.3219 83.3388 27.3125 82.3283 27.3125 81.0942C27.3125 79.8589 28.323 78.8495 29.5572 78.8495H111.512C112.746 78.8495 113.756 79.86 113.756 81.0942C113.756 82.3283 112.746 83.3388 111.512 83.3388ZM111.512 91.7369H29.5572C28.3219 91.7369 27.3125 90.7264 27.3125 89.4923C27.3125 88.257 28.323 87.2476 29.5572 87.2476H111.512C112.746 87.2476 113.756 88.2581 113.756 89.4923C113.756 90.7264 112.746 91.7369 111.512 91.7369Z" fill="#C01D2E"></path>
                    <path d="M142.247 81.0938V165.572H0.898438V81.0938L71.5718 126.326L142.247 81.0938Z" fill="#C01D2E"></path>
                    <path d="M71.5729 111.359L0.898438 165.57H142.246L71.5729 111.359Z" fill="#930F1D"></path>
                    <path d="M155.223 0L138.93 12.823L129.266 8.87387L155.223 0Z" fill="#C01D2E"></path>
                    <path d="M138.938 12.823L139.078 19.9302L155.231 0L138.938 12.823Z" fill="#D1A12B"></path>
                    <path d="M141.919 14.7625L139.07 19.9294L143.386 14.7461L141.919 14.7625Z" fill="#6D3E18"></path>
                    <path d="M155.225 -0.000244141L149.077 22.1179L141.922 14.763L155.225 -0.000244141Z" fill="#C01D2E"></path>
                    <path d="M91.2188 29.6953C91.4632 29.9016 91.7109 30.1012 91.9608 30.2944" stroke="#6D3E18" stroke-width="0.218246" stroke-miterlimit="10" stroke-linecap="round"></path>
                    <path d="M93.5 31.3784C98.7248 34.7077 104.565 35.094 108.377 32.45C112.4 29.6586 114.717 23.1069 112.402 20.5861C110.19 18.1778 103.615 19.2974 102.233 22.2808C100.658 25.6822 105.598 32.02 110.708 34.1446C117.786 37.0888 127.703 32.8384 136.141 23.6961" stroke="#6D3E18" stroke-width="0.218246" stroke-miterlimit="10" stroke-linecap="round"></path>
                    <path d="M136.781 22.9982C136.992 22.7625 137.201 22.5224 137.409 22.2812" stroke="#6D3E18" stroke-width="0.218246" stroke-miterlimit="10" stroke-linecap="round"></path>
                  </svg>
        ...
        <div class="col-xl-4 col-lg-4  mb-3">
          <div class="enquiry_box text-center">
            <div class="img_top mb-2">
              <img src="assets/images/phone-assistance.svg" alt="" width="94">
            </div>
            <h4>Add Market</h4>
            <a href="tel:+91  7877051909" class="btn btn_red my-3">CALL :
              +91 7877051909</a>
          </div>
        </div>
      </div>
      ...
      <div class="tabledesign_starling mb-4 ">
        <div class="top_bg">
          <h2 class="pb-3 text-center">Kalyan Starline</h2>
        </div>
        <div class="row justify-content-center">
          <div class="col-xl-10 resp">
            <div class="center-table">
              <div class="row">
                <div class="col-xl-12">
                    ...
                    <table class="table w-100 table-responsive">
                      <thead class="text-center">
                        <tr>
                          ...
                          <th class="thead_2">Time </th>
                          <th class="thead_2">Result</th>
                        </tr>
                      </thead>
                      <tbody class="text-center tbody">
                        ...
                        <tr>
                          <td> 10:30 AM</td>
                          <td>***-*</td>
                          <td style="background:rgb(249, 232, 233);color:#164863;">
                            05:30 PM
                          </td>
                          <td style="background:rgb(249, 232, 233);color:#164863;">
                            ***-*
                  ...
                  <div class="btn-chart text-center mt-3">
                    <a href="" class="btn btn_red py-1">View Chart</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  <section class="whatssp-banner">
    <div class="container section_padding_1">
      <div class="row mb-2 justify-content-center">
        <div class="col-xl-4 pb-3">
          <div class="notifucation_btn text-center">
            <div class="btn-nto d-flex align-items-center justify-content-center aos-init aos-animate" data-aos="fade-left" data-aos-duration="1000">
              <svg width="20" height="30" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19.4634 39.0729H19.4346C16.9007 39.0729 14.8394 37.0114 14.8394 34.4776V33.4038C14.8394 32.7774 15.3472 32.2695 15.9736 32.2695H22.9244C23.5508 32.2695 24.0587 32.7774 24.0587 33.4038V34.4776C24.0587 37.0115 21.9972 39.0729 19.4634 39.0729Z" fill="#FFA81C"></path>
                <path d="M22.9246 32.2695H19.4492V39.0729H19.4637C21.9975 39.0729 24.0589 37.0114 24.0589 34.4776V33.4038C24.0589 32.7773 23.551 32.2695 22.9246 32.2695Z" fill="#FF9300"></path>
                <path d="M21.7164 7.44195H17.1816C16.5552 7.44195 16.0474 6.93409 16.0474 6.30766V3.75454C16.0474 1.87882 17.5734 0.352905 19.449 0.352905C21.3247 0.352905 22.8506 1.87889 22.8506 3.75454V6.30766C22.8507 6.93409 22.3429 7.44195 21.7164 7.44195Z" fill="#FFA81C"></path>
                <path d="M21.7166 7.44195C22.343 7.44195 22.8509 6.93409 22.8509 6.30766V3.75454C22.8509 1.87882 21.3249 0.352905 19.4492 0.352905V7.44195H21.7166Z" fill="#FF9300"></path>
                <path d="M31.4685 34.5334H7.42945C6.44769 34.5334 5.64893 33.7346 5.64893 32.7529V31.1311C5.64893 29.3548 6.30295 27.649 7.49055 26.3279C8.30315 25.4239 8.75066 24.2568 8.75066 23.0413V15.6929C8.75066 9.7939 13.5498 4.99475 19.4488 4.99475C25.3479 4.99475 30.147 9.7939 30.147 15.6929V23.0413C30.147 24.2568 30.5945 25.4239 31.4071 26.3278C32.5948 27.6489 33.2488 29.3547 33.2488 31.1311V32.7528C33.2489 33.7346 32.4502 34.5334 31.4685 34.5334Z" fill="#FFCF2C"></path>
p>
            </div>
          </div>
        </div>
      </div>
      <div class="row mb-2 justify-content-center">
        <div class="col-xl-4 pb-3">
          <div class="notifucation_btn text-center">
            <div class="btn-nto d-flex align-items-center justify-content-center aos-init aos-animate" data-aos="fade-right" data-aos-duration="1000">
              <svg width="20" height="30" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19.4634 39.0729H19.4346C16.9007 39.0729 14.8394 37.0114 14.8394 34.4776V33.4038C14.8394 32.7774 15.3472 32.2695 15.9736 32.2695H22.9244C23.5508 32.2695 24.0587 32.7774 24.0587 33.4038V34.4776C24.0587 37.0115 21.9972 39.0729 19.4634 39.0729Z" fill="#FFA81C"></path>
                <path d="M22.9246 32.2695H19.4492V39.0729H19.4637C21.9975 39.0729 24.0589 37.0114 24.0589 34.4776V33.4038C24.0589 32.7773 23.551 32.2695 22.9246 32.2695Z" fill="#FF9300"></path>
                <path d="M21.7164 7.44195H17.1816C16.5552 7.44195 16.0474 6.93409 16.0474 6.30766V3.75454C16.0474 1.87882 17.5734 0.352905 19.449 0.352905C21.3247 0.352905 22.8506 1.87889 22.8506 3.75454V6.30766C22.8507 6.93409 22.3429 7.44195 21.7164 7.44195Z" fill="#FFA81C"></path>
              ...
              <p class="ms-1">अचूक जोड़ी पर कमाओ लाखों 100% फिक्स 1 जोड़ी 2 पत्ती</p>
            </div>
          </div>
        </div>
      </div>
      <div class="row mb-2 justify-content-center">
        <div class="col-xl-4 pb-3">
          <div class="notifucation_btn text-center">
            <div class="btn-nto d-flex align-items-center justify-content-center aos-init" data-aos="fade-left" data-aos-duration="1000">
              <svg width="20" height="30" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19.4634 39.0729H19.4346C16.9007 39.0729 14.8394 37.0114 14.8394 34.4776V33.4038C14.8394 32.7774 15.3472 32.2695 15.9736 32.2695H22.9244C23.5508 32.2695 24.0587 32.7774 24.0587 33.4038V34.4776C24.0587 37.0115 21.9972 39.0729 19.4634 39.0729Z" fill="#FFA81C"></path>
                <path d="M22.9246 32.2695H19.4492V39.0729H19.4637C21.9975 39.0729 24.0589 37.0114 24.0589 34.4776V33.4038C24.0589 32.7773 23.551 32.2695 22.9246 32.2695Z" fill="#FF9300"></path>
                <path d="M21.7164 7.44195H17.1816C16.5552 7.44195 16.0474 6.93409 16.0474 6.30766V3.75454C16.0474 1.87882 17.5734 0.352905 19.449 0.352905C21.3247 0.352905 22.8506 1.87889 22.8506 3.75454V6.30766C22.8507 6.93409 22.3429 7.44195 21.7164 7.44195Z" fill="#FFA81C"></path>
              ...
              <p class="ms-1">सिर्फ एक दिन में आपका पूरा लॉस कबर होगा मनी बैक गारंटी</p>
            </div>
          </div>
        </div>
      </div>
      <div class="row mb-2 justify-content-center">
        <div class="col-xl-4 pb-3">
          <div class="notifucation_btn text-center">
            <div class="btn-nto d-flex align-items-center justify-content-center aos-init" data-aos="fade-right" data-aos-duration="1000">
              <svg width="20" height="30" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19
8464 17.1989C17.8268 17.359 17.764 17.5108 17.6646 17.6379L17.1532 18.3016C17.0435 18.4386 16.9773 18.6053 16.9631 18.7803C16.949 18.9553 16.9875 19.1305 17.0737 19.2834C17.3601 19.7857 18.0464 20.5243 18.8078 21.2084C19.6623 21.9811 20.6101 22.6879 21.2101 22.9289C21.3706 22.9944 21.5471 23.0105 21.7169 22.9748C21.8866 22.9392 22.0417 22.8535 22.1623 22.7289L22.7555 22.1311C22.87 22.0183 23.0123 21.9378 23.168 21.8978C23.3237 21.8579 23.4872 21.86 23.6419 21.9039L26.0442 22.5857C26.1767 22.6263 26.2981 22.6967 26.3993 22.7915C26.5004 22.8863 26.5785 23.003 26.6276 23.1326C26.6768 23.2622 26.6956 23.4013 26.6827 23.5393C26.6698 23.6774 26.6255 23.8106 26.5533 23.9289Z" fill="#29A71A"></path>
            </svg>
            <a href="https://api.whatsapp.com/send?phone=+91 7877051909&amp;text=Hello" class="ms-1">WHATSAPP NOW 7877051909</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section  class="htplay">
    <div class="container">
      <div class="row pb-5" id="how">
        <div class="py-2 freegame">
          <div class="row justify-content-center">
            <div class="col-xl-8">
              <div class="steps_design d-md-block d-none">
                <svg width="100%" height="386" viewBox="0 0 981 386" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M383.393 35V11.4799H387.836V21.1493H398.354V11.4799H402.797V35H398.354V25.2979H387.836V35H383.393ZM417.477 35.49C415.125 35.49 413.094 34.9782 411.384 33.9547C409.686 32.9311 408.373 31.4992 407.448 29.659C406.533 27.8187 406.076 25.6791 406.076 23.2399C406.076 20.8008 406.533 18.6611 407.448 16.8209C408.373 14.9807 409.686 13.5488 411.384 12.5252C413.094 11.5017 415.125 10.9899 417.477 10.9899C419.829 10.9899 421.854 11.5017 423.553 12.5252C425.262 13.5488 426.574 14.9807 427.489 16.8209C428.415 18.6611 428.877 20.8008 428.877 23.2399C428.877 25.6791 428.415 27.8187 427.489 29.659C426.574 31.4992 425.262 32.9311 423.553 33.9547C421.854 34.9782 419.829 35.49 417.477 35.49ZM417.477 31.3086C418.968 31.3304 420.21 31.0092 421.201 30.345C422.192 29.6807 422.932 28.7389 423.422 27.5193C423.923 26.2997 424.173 24.8733 424.173 23.2399C424.173 21.6066 423.923 20.191 423.422 18.9933C422.932 17.7955 422.192 16.8645 421.201 16.2002C420.21 15.536 418.968 15.193 417.477 15.1712C415.985 15.1495 414.744 15.4707 413.753 16.1349C412.762 16.7991 412.016 17.741 411.515 18.9606C411.025 20.1801 410.78 21.6066 410.78 23.2399C410.78 24.8733 411.025 26.2888 411.515 27.4866C412.016 28.6844 412.762 29.6154 413.753 30.2796C414.744 30.9439 415.985 31.2869 417.477 31.3086ZM436.082 35L429.189 11.4799H433.86L438.27 27.65L442.68 11.5125L447.352 11.4799L451.762 27.65L456.172 11.4799H460.843L453.95 35H449.573L445.016 19.1239L440.459 35H436.082ZM475.46 35V15.6286H468.045V11.4799H487.318V15.6286H479.903V35H475.46ZM500.037 35.49C497.685 35.49 495.654 34.9782 493.945 33.9547C492.246
.5 327.55 151.826 327.358 152.057 327.089C152.287 326.813 152.445 326.509 152.529 326.178C152.622 325.84 152.668 325.521 152.668 325.222C152.668 324.922 152.622 324.607 152.529 324.276C152.445 323.938 152.287 323.634 152.057 323.365C151.826 323.089 151.5 322.893 151.077 322.777C150.915 322.731 150.739 322.7 150.546 322.685C150.354 322.67 150.177 322.662 150.016 322.662H146.281V327.781ZM165.64 336.336V323.146L162.528 325.06V321.601L165.64 319.733H168.846V336.336H165.64Z" fill="#C01D2E"></path>
                  ...
                  <defs>
                    <linearGradient id="paint0_linear_26_1895" x1="275.151" y1="221.692" x2="678.394" y2="97.6427" gradientUnits="userSpaceOnUse">
                      <stop stop-color="#C01D2E"></stop>
                      <stop offset="1" stop-color="#164863"></stop>
                    </linearGradient>
                    <clipPath id="clip0_26_1895">
                      <rect width="52.8434" height="52.8434" fill="white" transform="translate(103.766 155.727)"></rect>
                    </clipPath>
                    <clipPath id="clip1_26_1895">
                      <rect width="52.8434" height="52.8434" fill="white" transform="translate(333.391 163.414)"></rect>
                    </clipPath>
                    <clipPath id="clip2_26_1895">
                      <rect width="57.6474" height="57.6474" fill="white" transform="translate(817.625 157.648)"></rect>
                    </clipPath>
                  </defs>
                </svg>

              </div>
              <div class="steps_design d-md-none d-block text-center">
                <a href="app-release.apk">
                       <img src="https://deepmatka.co.in/assets/images/howtplay.png" alt=""> 
                    </a>
              </div>
            </div>
          </div>
      ...
      <div class="row pb-5 " id="rate">
        <div class="py-2 freegame">
          <div class="title-onilne text-center">
            <h2 class="title-black">GAME PLAY RATES</h2>
          </div>
          <div class="row justify-content-center">
            <div class="col-xl-10">
              <div class="row row-cols-1 rows-col-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-4 row-cols-xxl-4 mt-4 px-5">
                <div class="col pb-3 text-center mb-2">
                  <div class="games_steps text-center">
                    <div class="cercle_red">
                      <img src="https://deepmatka.co.in/uploads/images/1678519745_dyce.png" alt="" width="100%">
                    </div>
                    <div class="arrow-triangle right"></div>
                  </div>
                  <div class="steps-content py-4 text-center">
                    <p>SINGAL DIGIT 10 ka 95</p>
                  </div>
                </div>
                <div class="col pb-3 text-center mb-2">
                  <div class="games_steps text-center">
                    <div class="cercle_red">
                      <img src="https://deepmatka.co.in/uploads/images/1678519762_dyce2.png" alt="" width="100%">
                    </div>
                    <div class="arrow-triangle right"></div>
                  </div>
                  <div class="steps-content py-4 text-center">
                    <p>JODI DIGIT 10 ka 900</p>
                  </div>
                </div>
                <div class="col pb-3 text-center mb-2">
                  <div class="games_steps text-center">
                    <div class="cercle_red">
                      <img src="https://deepmatka.co.in/uploads/images/1678519816_akka.png" alt="" width="100%">
                    </div>
                    <div class="arrow-triangle right"></div>
                  </div>
                  <div class="steps-content py-4 text-center">
                    <p>SINGLE PANA 10 ka 1400</p>
                  </div>
                </div>
                <div class="col pb-3 text-center mb-2">
                  <div class="games_steps text-center">
                    <div class="cercle_red">
                      <img src="https://deepmatka.co.in/uploads/images/1678519807_duble.png" alt="" width="100%">
                    </div>
                    <div class="arrow-triangle right"></div>
                  </div>
                  <div class="steps-content py-4 text-center">
                    <p>DOUBLE PANA 10 ka 2800</p>
                  </div>
                </div>
                <div class="col pb-3 text-center mb-2">
                  <div class="games_steps text-center">
                    <div class="cercle_red">
                      <img src="https://deepmatka.co.in/uploads/images/1678519833_hukumakka.png" alt="" width="100%">
                    </div>
                    <div class="arrow-triangle right"></div>
                  </div>
                  <div class="steps-content py-4 text-center">
                    <p>TRIPLE PANA 10 ka 7000</p>
                  </div>
                </div>
                <div class="col pb-3 text-center mb-2">
                  <div class="games_steps text-center">
                    <div class="cercle_red">
                      <img src="https://deepmatka.co.in/uploads/images/1678519853_dyce3.png" alt="" width="100%">
                    </div>
                    <div class="arrow-triangle right"></div>
                  </div>
                  <div class="steps-content py-4 text-center">
                    <p>HALF SANGAM 10 ka 10000</p>
                  </div>
                </div>
                <div class="col pb-3 text-center mb-2">
                  <div class="games_steps text-center">
                    <div class="cercle_red">
                      <img src="https://deepmatka.co.in/uploads/images/1678519872_dyce4.png" alt="" width="100%">
                    </div>
                    <div class="arrow-triangle right"></div>
                  </div>
                  <div class="steps-content py-4 text-center">
                    <p>FULL SANGAM 10 ka 100000</p>
                  </div>
                </div>
...
<footer class="main_footer" style="background: url('assets/images/ruppesbg.png') no-repeat top center; background-size: 100% 100%;">
  <button id="fcmbtnsubmit" onclick="startFCM()" class="btn btn-danger btn-flat d-none">Allow notification
  </button>
  <div class="container">
    <div class="row">
      <div class="logo_footer text-center pt-4 pb-2">
    ...
    <div class="row">
      <div class="col-xl-12">
        <div class="footer-copy text-center">
          <p class="py-3"><a href="">@2026 khatri 567</a></p>
        </div>
      </div>
    </div>
  </div>
